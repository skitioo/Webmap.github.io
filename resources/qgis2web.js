...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'USER:100026',
            extent: [172.919600, 1.357298, 2578689.372227, 180914.800100],
            units: 'm'})
    })
});
...
map.getView().fit([26700.666902, 147962.470359, 32743.071021, 151255.303429], map.getSize());
